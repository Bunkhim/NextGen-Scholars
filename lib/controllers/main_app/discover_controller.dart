...
class DiscoverController extends GetxController {
  ...
  // Replaced raw Stream with GetX reactive variables
  final RxList<FirestoreScholarship> scholarshipsList = <FirestoreScholarship>[].obs;
  final RxBool isLoading = true.obs;
  final RxBool hasError = false.obs;
  StreamSubscription? _scholarshipSubscription;
  ...
  void onInit() {
    ...
    // Listen to the stream immediately and store data in RxList
    _scholarshipSubscription = scholarshipService.streamActiveScholarships().listen(
      (data) {
