    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        return StreamBuilder<List<AppNotification>>(
          stream: controller.notificationService.streamMyNotifications(),
          builder: (context, snapshot) {
            final raw = snapshot.data ?? [];
            final notifications = controller.applySettingsFilter(raw);
              ...
              slivers: [
                SliverAppBar(
                  ...
                  actions: [
                    if (unreadCount > 0)
                      TextButton(
                        onPressed: () => controller.notificationService.markAllAsRead(),
                        child: Text(
                    ...
                    child: Container(
                      ...
                      child: const Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text('Clear', style: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w600)),
                        ],
                      ),
                    ),
                  ),
                              ...
                              child: Column(
                                ...
                                children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          ...
                                          style: TextStyle(
                                            ...
                                            color: item.isRead ? colorScheme.onSurfaceVariant : colorScheme.onSurface,
                                          ),
                                        ),
                                      ),
                                      if (!item.isRead)
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 13,
                                      color: item.isRead ? colorScheme.outline : colorScheme.onSurfaceVariant,
                                      height: 1.4,
                                    ),
                                  ...
                                  if (timeAgo.isNotEmpty) ...[
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(timeAgo, style: TextStyle(fontSize: 12, color: colorScheme.outline)),
                                      ],
                                    ),
                                  ],
                                ],
