...
part 'homescreens_binding.dart';
part 'homescreens_controller.dart';
...
class HomeScreenView extends GetView<HomeScreenViewController> {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 24),
                  Obx(() => _buildQuickActions(context)),
                  const SizedBox(height: 24),
                  _buildSectionHeader(context),
                  const SizedBox(height: 12),
                  _buildScholarshipCards(context),
                  const SizedBox(height: 24),
                  _buildFeatureShowcaseSection(context),
                  const SizedBox(height: 24),
                ],
              ),
            ),
  ...
  Widget _buildQuickActions(BuildContext context) {
    ...
    final actionMap = {
      ...
      'match': (
        ...
        onTap: controller.handleMatchTap,
      ),
      'applications': (
      ...
      'fillInfo': (
        ...
        onTap: () {
          Get.to(() => const PersonalInfoScreenView());
        },
      ),
    };
        ...
        children: [
          ...
          ReorderableGridView.count(
            ...
            onReorder: (oldIndex, newIndex) {
              final item = controller.actionOrder.removeAt(oldIndex);
              controller.actionOrder.insert(newIndex, item);
              controller.saveActionOrder();
            },
            children: [
  ...
  Widget _buildScholarshipCards(BuildContext context) {
    final colorScheme = Theme.of(context).colorScheme;
                ...
                itemBuilder: (context, index) {
                  ...
                  return SizedBox(
                    ...
                    child: ScholarshipCard(
                      ...
                      onFavoriteToggle: () {
                        controller.toggleFavorite(scholarship);
                      },
                      onTap: () {
                        Get.toNamed(Routes.scholarshipDetail,
                                arguments: scholarship)
                            ?.then((_) => controller.loadFavorites());
                      },
                    ),
                  );
                },
  ...
  Widget _buildFeatureShowcaseSection(BuildContext context) {
    final t = AppLocalizations.of(context);
    final colorScheme = Theme.of(context).colorScheme;
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget build(BuildContext context) {
    ...
    final features = [
      _FeatureTile(
        ...
        onTap: () => Get.to(() => const WallpaperScreenView()),
      ),
      _FeatureTile(
        imageUrl:
      ...
      _FeatureTile(
        ...
        onTap: () => Get.to(() => const ChatAiScreenView()),
      ),
      _FeatureTile(
        imageUrl:
        ...
        onTap: () => Get.to(() => const PersonalInfoScreenView()),
      ),
      _FeatureTile(
        imageUrl:
      ...
      _FeatureTile(
        ...
        onTap: () =>
            Get.toNamed(Routes.savedScholarship),
      ),
      _FeatureTile(
        imageUrl:
