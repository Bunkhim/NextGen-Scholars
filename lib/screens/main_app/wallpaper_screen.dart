...
class _WallpaperScreenState extends State<WallpaperScreen> {
  // Current selection state (null = default / no theme)
  ...
  void initState() {
    super.initState();
    _selectedThemeId = WallpaperService().currentThemeId;
    _selectedImagePath = WallpaperService().currentWallpaper;
  }

  bool get _isDefault => _selectedThemeId == null && _selectedImagePath == null;
  ...
  Future<void> _apply() async {
    ...
    if (_selectedThemeId != null) {
      await WallpaperService().setTheme(_selectedThemeId);
    } else if (_selectedImagePath != null) {
      await WallpaperService().setWallpaper(_selectedImagePath);
    } else {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildThemeGrid(context, colorScheme, t),
                    const SizedBox(height: 24),
                    ...
                    _buildSectionLabel(
                        ...
                        colorScheme),
                    const SizedBox(height: 12),
                    _buildCustomRow(context, colorScheme, t, isDark),
                    const SizedBox(height: 28),

                    // ── Apply button ─────────────────────────────────────
                    _buildApplyButton(context, colorScheme, t),
                ...
                children: [
                  ...
                  Positioned.fill(
                    child: _PhoneMockOverlay(
                      ...
                      isDark: _isLightTheme(_selectedThemeId) ? false : true,
                    ),
                  ),
                  // Badge
                  Positioned(
  ...
  // ── Helper: is this a light-colored theme? ─────────────────────────────────

  static bool _isLightTheme(String? themeId) {
    // Only themes with a light/pale gradient background
    const lightIds = {
      'lunar',
      'march_8',
      'khmer_new_year',
