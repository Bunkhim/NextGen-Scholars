...
part 'my_applications_screen_controller.dart';
part 'my_applications_screen_binding.dart';

class MyApplicationsScreenView
    extends GetView<MyApplicationsScreenViewController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<ScholarshipApplication>>(
        stream: controller.service.streamMyApplications(),
...
class _ActionButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void navigate() {
      Get.toNamed(Routes.applicationStatus, arguments: application);
    }
