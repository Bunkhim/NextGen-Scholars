...
const MESSAGES = {
    ...
    km: {
        welcome:
            ...
            "សូមប្រើម៉ឺនុយខាងក្រោម ឬវាយសំណួរ!",
        help:
            "📖 *ពាក្យបញ្ជាដែលមាន:*\n\n" +
            "/start – សូមស្វាគមន៍ និងម៉ឺនុយ\n" +
        ...
        faq: [
            ...
            },
            {
                ...
                a:
                    ...
                    "🟢 ទទួលយក – សូមអបអរសាទរ!\n" +
                    "🔴 មិនត្រូវបានជ្រើសរើស – សូមព្យាយាមអាហារូបករណ៍ផ្សេង\n" +
            ...
            {
                q: "តើខ្ញុំគួរធ្វើអ្វីប្រសិនបើពាក្យសុំមិនត្រូវបានជ្រើសរើស?",
                a:
                    "កុំខកចិត្ត! 💪\n\n" +
        ...
        agentForward:
            ...
            "អ៊ីមែលមក choubkhunrithy@gmail.com សម្រាប់ករណីប្រញាប់។",
        statusNotFound:
...
function findAutoReply(text, lang) {
    ...
    const rules = [
        ...
        {
            patterns: ["reject", "not selected", "failed", "មិនត្រូវបានជ្រើសរើស"],
            faqIndex: 4,
        },
    ];
